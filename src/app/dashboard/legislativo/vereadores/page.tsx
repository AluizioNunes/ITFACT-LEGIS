...
import { columns, Vereador } from "@/app/dashboard/legislativo/vereadores/columns";
...
import { VereadorModal } from "./VereadorModal";

const mockData: Vereador[] = [
    { id: "1", nomeParlamentar: "VER. JOÃO SILVA", partido: { nome: "Partido Renovador", sigla: "PR" }, cargo: "VEREADOR", status: "ATIVO" },
    { id: "2", nomeParlamentar: "VERA. MARIA SOUZA", partido: { nome: "Liderança Cidadã", sigla: "LC" }, cargo: "1ª SECRETÁRIA", status: "ATIVO" },
    { id: "3", nomeParlamentar: "VER. CARLOS LIMA", partido: { nome: "Partido Renovador", sigla: "PR" }, cargo: "VEREADOR", status: "ATIVO" },
    { id: "4", nomeParlamentar: "VER. RICARDO OLIVEIRA", partido: { nome: "Independentes", sigla: "IND" }, cargo: "VEREADOR", status: "ATIVO" },
    { id: "5", nomeParlamentar: "VERA. ANA SANTOS", partido: { nome: "Liderança Cidadã", sigla: "LC" }, cargo: "VICE-PRESIDENTE", status: "ATIVO" },
];
        ...
        <div className="p-6 space-y-6 bg-slate-50/50 min-h-screen">
            ...
            <div className="flex justify-between items-center bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
                <div className="space-y-1">
                    ...
                    <p className="text-slate-500 font-medium">Análise de produtividade, bancadas e gestão de mandatos.</p>
                </div>
                <Button
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <Card className="rounded-3xl border-none shadow-sm bg-gradient-to-br from-blue-600 to-blue-700 text-white">
                    ...
                    <CardContent>
                        ...
                        <p className="text-[10px] mt-1 font-medium opacity-70 italic">Legislatura 2024-2028</p>
                    </CardContent>
                </Card>
                ...
                <Card className="rounded-3xl border-none shadow-sm bg-white">
                    ...
                    <CardContent>
                        ...
                        <p className="text-[10px] mt-1 font-medium text-slate-400 font-bold uppercase tracking-widest">Média 5.7 por vereador</p>
                    </CardContent>
                </Card>
